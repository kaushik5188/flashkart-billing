      ...
      <div id="fk-print-root" style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.72)', zIndex: 600, overflowY: 'auto', padding: '20px 0', display: 'block', textAlign: 'center' }}>
        ...
        <div id="fk-invoice-document" className="fk-invoice-page" style={{
          ...
          <div style={{ position: 'relative', backgroundColor: '#fff', overflow: 'hidden', flexShrink: 0 }} className="avoid-break">
            ...
            {/* Header body with full vegetable bg image */}
            <div style={{
              backgroundImage: 'url(/inv_header.png)',
          ...
          <div style={{ padding: '0 20px 6px', display: 'flex', gap: '12px', alignItems: 'flex-start', marginTop: '2px', flexShrink: 0 }} className="avoid-break">
            ...
            <div style={{ flex: 1.1 }}>
              ...
              <div style={{ textAlign: 'center', marginBottom: '8px' }}>
                <div style={{
                  ...
                  fontSize: '26px', color: '#2E7D32', fontWeight: 700, lineHeight: 1.1
                }}>
                  Thank You!
                </div>
            ...
            <div style={{ flex: 1.1 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '30px' }}>
                ...
                {/* Signature Line */}
                <div style={{ padding: '6px 0 4px 0', borderTop: '1.5px solid #333', fontSize: '10px', color: '#111', fontWeight: 800, minWidth: '180px', textAlign: 'center' }}>
                  Authorized Signature
                </div>

                {/* Provided Exact Final Stamp Image */}
                <img src="/final_stamp.png" alt="Authorized Stamp" style={{
                  width: '135px',
                  height: '135px',
                  marginTop: '8px',
          ...
          <div style={{ padding: '5px 20px', fontSize: '8.5px', color: '#444', lineHeight: '1.4', marginTop: '5px', borderTop: '1px dashed #E0E0E0' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{ display: 'flex', gap: '6px' }}>
                <span style={{ color: '#2E7D32', fontWeight: 800 }}>1.</span>
                <span>Please check the quantity and quality of goods at the time of delivery.</span>
              </div>
              <div style={{ display: 'flex', gap: '6px' }}>
                <span style={{ color: '#2E7D32', fontWeight: 800 }}>2.</span>
                <span>Any issue or shortage must be reported immediately upon delivery.</span>
              </div>
              <div style={{ display: 'flex', gap: '6px' }}>
                <span style={{ color: '#2E7D32', fontWeight: 800 }}>3.</span>
                <span>Report any issue immediately to our team.</span>
              </div>
              <div style={{ display: 'flex', gap: '6px' }}>
                <span style={{ color: '#2E7D32', fontWeight: 800 }}>4.</span>
                <span>FLASHKART will take responsibility for genuine delivery-related issues reported at the time of delivery.</span>
              </div>
            </div>
          </div>
          {/* ── FOOTER SPACE ─────────────────────────────── */}
